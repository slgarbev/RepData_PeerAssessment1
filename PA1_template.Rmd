...
hist(dailysteps,breaks = 10,xlab = "Daily Steps",main = "Histogram of Daily Steps")
...
intervalsteps<-with(activity,tapply(steps, interval, mean))
        plot(intervalsteps, ylab = "Average Steps",xlab = "Time",main = "Average Daily Activity Pattern",xaxt="n")
...
hist(dailysteps2,breaks = 10,xlab = "Daily Steps",main = "Histogram of Daily Steps (adjusted NA values")
...
ggplot(totalsteps, aes(x=interval,y=mean))+geom_point()+facet_grid(type~.)+labs(title = "Average Steps by Interval",x="Interval",y="Average Steps")
```
